...
class MCQGenerator(toga.App):
    def startup(self):
        ...
        self.dropdown = toga.Selection(items=["Select Mode","PDF Mode", "Hint generator", "Paragraph Mode"], style=Pack(width=200, padding_bottom=20))
    ...
    def show_pdf_mode_content(self,widget):
        pdf_label = toga.Label("PDF Mode Content", style=Pack(text_align=CENTER, font_size=15, padding_bottom=20))
        self.main_box.add(pdf_label)

    #code for hint generator mode
    def show_hint_generator_content(self, widget):
        hint_label = toga.Label("Hint Generator Content", style=Pack(text_align=CENTER, font_size=15, padding_bottom=20))
    ...
    def txt_file_question_write(widget):
        pass
    def ms_word_file_question_write(widget):
        pass
